---
title: Core Features
description: Explore the main capabilities of RankRocket ContentIQ to analyze audience demographics, engagement patterns, and content performance.
---
...
<Expandable title="View Recommendations" default-open="true">
  RankRocket ContentIQ analyzes past performance and suggests optimal posting times, content types, and hashtags. For example, post videos on Wednesdays at `2 PM EST` for max reach.
</Expandable>
...
<Columns cols={2}>
  <Card title="Next: Quickstart" icon="rocket" href="/quickstart">
    Set up RankRocket ContentIQ in minutes.
  </Card>
